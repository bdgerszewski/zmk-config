...
west build -s zmk/app -d /home/ben/zmk-dongle-build-mctech-aluminum/reset -b nice_nano_v2 -p always --  -DZMK_CONFIG=/home/ben/repos/zmk-config/config -DSHIELD="settings_reset" &
wait

BUILD_OUTPUT_DIR="/mnt/c/Users/skipp/Documents/zmk-local-build-25july"
mkdir -p $BUILD_OUTPUT_DIR
# mkdir -p /home/ben/corne-fw-mctech-aluminum
cp /home/ben/zmk-dongle-build-mctech-aluminum/left/zephyr/zmk.uf2   $BUILD_OUTPUT_DIR/corne_left.uf2
cp /home/ben/zmk-dongle-build-mctech-aluminum/right/zephyr/zmk.uf2  $BUILD_OUTPUT_DIR/corne_right.uf2
cp /home/ben/zmk-dongle-build-mctech-aluminum/dongle/zephyr/zmk.uf2 $BUILD_OUTPUT_DIR/corne_dongle.uf2
cp /home/ben/zmk-dongle-build-mctech-aluminum/reset/zephyr/zmk.uf2  $BUILD_OUTPUT_DIR/corne_reset.uf2
